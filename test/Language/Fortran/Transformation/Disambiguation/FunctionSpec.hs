...
ex1pu1bs =
  ...
  , BlStatement
    ...
    (StExpressionAssign
      ()
      u
      (ExpSubscript () u (varGen "c") (AList () u [IxSingle () u Nothing $ varGen "x"]))
      (intGen 1)
    )
  , BlStatement
    ()
    ...
    (StExpressionAssign
      ()
      u
      (ExpSubscript () u (varGen "d") (AList () u [IxSingle () u Nothing $ varGen "x"]))
      (intGen 1)
    )
  , BlStatement ()
                u
                Nothing
                (StExpressionAssign () u (ExpFunctionCall () u (varGen "e") Nothing) (intGen 1))
  ]
...
expectedEx1pu1bs =
  ...
  , BlStatement
    ...
    u
    Nothing
    (StFunction () u (ExpValue () u $ ValVariable "c") (AList () u [varGen "x"]) (intGen 1))
  , BlStatement
    ()
    u
    Nothing
    (StFunction () u (ExpValue () u $ ValVariable "d") (AList () u [varGen "x"]) (intGen 1))
  , BlStatement ()
                u
                Nothing
                (StFunction () u (ExpValue () u $ ValVariable "e") (AList () u []) (intGen 1))
  ]
...
ex2pu2 = PUFunction ()
                    ...
                    (None () u False)
                    "y"
                    (Just $ AList () u [varGen "i", varGen "j"])
                    Nothing
                    []
                    Nothing
ex2pu1bs :: [Block ()]
ex2pu1bs =
  [ BlStatement
    ...
    u
    Nothing
    (StFunction () u (ExpValue () u (ValVariable "f")) (AList () u [varGen "x"]) (intGen 1))
  , BlStatement
    ()
    u
    Nothing
    (StExpressionAssign
      ...
      u
      (varGen "i")
      (ExpBinary () u Addition (intGen 1) (ExpSubscript () u (varGen "f") (AList () u [ixSinGen 1]))
      )
    )
  ]
